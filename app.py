...
def main():
    ...
    with tab2:
        ...
        st.session_state.challenge = st.text_area("Challenge (EN Only)", st.session_state.challenge)
        st.session_state.solution = st.text_area("Solution (EN Only)", st.session_state.solution)
