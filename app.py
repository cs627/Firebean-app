...
def main():
    ...
    # API 設定
    api_key = "AIzaSyDupK7JjQAjcR5P5f9eqyev5uYRe4ZOKdI" # 請確保 Key 有效
    ...
    with tab1:
        ...
        with col_l:
            ...
            if audio_input is not None:
                ...
                if audio_bytes:
                    with st.spinner("聽緊你講咩... AI 正在解碼..."):
                        try:
                            # 建立內容列表，將 bytes 包裝成正確格式
                            content = [
                                "請精確轉錄這段廣東話錄音，並從中提取項目詳情 (Client, Venue, Challenge, Result)。",
